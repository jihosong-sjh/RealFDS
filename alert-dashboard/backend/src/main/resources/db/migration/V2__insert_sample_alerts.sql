...
INSERT INTO alerts (
    ...
    rule_name, reason, severity, alert_timestamp, status, processed_at, created_at
) VALUES
    ...
    (
        ...
        'HIGH', '2025-11-11T12:00:00Z', 'UNREAD', NULL, '2025-11-11T12:00:01Z'
    ),
    ...
    (
        ...
        'MEDIUM', '2025-11-11T11:30:00Z', 'IN_PROGRESS', NULL, '2025-11-11T11:30:01Z'
    ),
    -- 샘플 3: 연속 거래 알림 (완료 상태)
    (
        ...
        'LOW', '2025-11-11T10:45:00Z', 'COMPLETED', '2025-11-11T10:46:00Z', '2025-11-11T10:45:01Z'
    );
